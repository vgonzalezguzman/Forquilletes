...
<template>
    <Layout :user="user" class="flex flex-col w-full h-full">
        <div class="flex flex-col w-full h-2/6 md:h-1/6 lg:h-1/6">
            <div class="flex flex-row w-full justify-center">
                <div class="w-fit p-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-name">
                        Valoració mínima
                    </label>
                    <input type="number" v-model.number="minRating" placeholder="Valoració mínima"
        ...
        <div class="w-full h-4/6 md:h-5/6 lg:h-5/6">
